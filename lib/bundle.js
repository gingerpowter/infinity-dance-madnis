...
class Game {
  ...
  play(difficulty) {
    ...
    const LcreateLeftArrow = () => {
      ...
      function leftTick(event) {
        ...
        if (that.LleftArrows[0] && that.LleftArrows[0].y > 550) {
          that.miss();
    ...
    const LcreateDownArrow = () => {
      ...
      function downTick(event) {
        ...
        if (that.LdownArrows[0] && that.LdownArrows[0].y > 550) {
          that.miss();
    ...
    const LcreateUpArrow = () => {
      ...
      function upTick(event) {
        ...
        if (that.LupArrows[0] && that.LupArrows[0].y > 550) {
          that.miss();
    ...
    const LcreateRightArrow = () => {
      ...
      function rightTick(event) {
        ...
        if (that.LrightArrows[0] && that.LrightArrows[0].y > 550) {
          that.miss();
    ...
    const RcreateLeftArrow = () => {
      ...
      function leftTick(event) {
        leftMovingArrow.y = leftMovingArrow.y - speed;
        if (that.RleftArrows[0] && that.RleftArrows[0].y > 550) {
          that.miss();
    ...
    const RcreateDownArrow = () => {
      ...
      function downTick(event) {
        downMovingArrow.y = downMovingArrow.y - speed;
        if (that.RdownArrows[0] && that.RdownArrows[0].y > 550) {
          that.miss();
    ...
    const RcreateUpArrow = () => {
      ...
      function upTick(event) {
        upMovingArrow.y = upMovingArrow.y - speed;
        if (that.RupArrows[0] && that.RupArrows[0].y > 550) {
          that.miss();
    ...
    const RcreateRightArrow = () => {
      ...
      function rightTick(event) {
        rightMovingArrow.y = rightMovingArrow.y - speed;
        if (that.RrightArrows[0] && that.RrightArrows[0].y > 550) {
          that.miss();
  ...
  check(arrows, direction) {
    ...
    this.stage.update();
    setTimeout( () => this.stage.removeChild(pressed), 590);

    if (arrows[0] && arrows[0].y < 518 && arrows[0].y > 490) {
      if (this.life > 0) {
        this.hit("excellent");
      }
      ...
      arrows.shift();
    } else if (arrows[0] && arrows[0].y < 530 && arrows[0].y > 436) {
      if (this.life > 0) {
        this.hit("great");
      }
      createjs.Ticker.off("tick", arrows[0].listener);
